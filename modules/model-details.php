...
if( isset($_POST['kundeneu']) )
{	
	echo '<script type="text/javascript">window.location.href="' . $GLOBALS['HOST'] . '/kunden/neu/' . $_POST['idkunde'] . '/";</script>';	
//	header("Location: );
	die();
}
...
{
$Model=new Modele();	
$iIdKundeNew=$Model->updModele($_POST['vorname'],$_POST['nachname'],$_POST['geburstag'],$_POST['strasse'],$_POST['ort'],$_POST['plz'],$_POST['telefon'],
...
$_POST['bewertung'],$_POST['notizien'],$fo1,'fo2','fo3','fo4',$iIdUser,$IDKUNDE);		
...
$_POST['email'],$_POST['bereiche'],$_POST['kosten'],$_POST['letztesshotinge'],$_POST['grosse'],$_POST['gewicht'],$_POST['augen'],
$_POST['konfektion'],$_POST['brust'],$_POST['taille'],$_POST['bh'],$_POST['haare'],$_POST['hufte'],$_POST['sedcard'],
$_POST['bewertung'],$_POST['notizien'],$fotox,'fo2','fo3','fo4',$iIdUser,$IDKUNDE);		
	
}
if(!empty($iIdKundeNew))
?>
<script>
alert("Der Model ist geschpeichert!");
</script>
								
<?php					
}
$Modele=new Modele();
$arrModels=$Modele->get($IDKUNDE);
?>
<h1>Model: Detailansicht (idmodel: <?php echo $_GET['param1']; ?>) </h1>
...
<form action="" method="post" enctype="multipart/form-data" >
  	<fieldset>
  		...
  		<table>
  			<tr>
  				<td width="15" ><label>Vorname:</td><td width="15"><input type="vorname" name="vorname" value="<?php echo $arrModels['name'] ?>" /></label></td>
  				<td width="15" > <label>Nachname:</td><td width="15"><input type="nachname" name="nachname" value="<?php echo $arrModels['surname'] ?>" /></label></td>
  			    <td width="15"><label>Geburstag:</td><td width="15">
  			    	<input type="text" name="geburstag" id="datum_zahlung" value="<?php echo $arrModels['birthdate'] ?>" />
  			    	
  		    </tr>
  			<tr>
  				<td width="15"><label>Strasse:</td><td width="15"><input type="strasse" name="strasse" value="<?php echo $arrModels['street'] ?>" /></label></td>
  				<td width="15"><label>Ort:</td><td width="15"><input type="ort" name="ort" value="<?php echo $arrModels['place'] ?>" /></label></td>
  				<td width="15"><label>PLZ:</td><td width="15"><input type="plz" name="plz" value="<?php echo $arrModels['zip'] ?>" /></label></td>
  			</tr>
  			<tr>
  			    <td width="15"><label>Telefon:</td><td width="15"><input type="telefon" name="telefon" placeholder="Telefon..." value="<?php echo $arrModels['telefon'] ?>" /></label></td>
  			    <td width="15"><label>Email:</td><td width="15"><input type="email" name="email" value="<?php echo $arrModels['email'] ?>" placeholder="Email..." /></label></td>
  			</tr>
  	    </table>
  ...
  <?php 
  			echo "<option selected value='$arrModels[field]'>$arrModels[field]</option>";
  ...
  <option value="werbung">Werbung</option>
  				...
  				<td width="15" > <label>Kosten:</td><td width="15"><input type="kosten" name="kosten" value="<?php echo $arrModels['cost'] ?>" /></label></td>
  			    <td width="15"><label>Letztes Shoting:</td><td width="15">
  			    	<input type="text" name="letztesshotinge" id="datum_zahlung1" value="<?php echo $arrModels['last_shoting'] ?>" />
  		...
  		<table>
  			<tr>
  			    <td width="15" ><label>Grosse:</td><td width="15"><input type="grosse" name="grosse" value="<?php echo $arrModels['size'] ?>" /></label></td>
  				<td width="15" > <label>Konfektion:</td><td width="15">
  				 <select name="konfektion">
  				<?php echo "<option selected value='$arrModels[konfektion]'>$arrModels[konfektion]</option>";?>
  			    ...
  			    <td width="15"><label>BH:</td><td width="15">
  			      ...
  			      <select name="bh">
  			      <?php echo "<option selected value='$arrModels[bh]'>$arrModels[bh]</option>";?>
  			    ...
  			    <td width="15"><label>Schuhe:</td><td width="15">
  			    	<select name="schuhe">
  			    <?php echo "<option selected value='$arrModels[schuhe]'>$arrModels[schuhe]</option>";?>		
  			...
  			<tr>
  				<td width="15"><label>Gewicht:</td><td width="15"><input type="gewicht" name="gewicht" value="<?php echo $arrModels['size'] ?>" /></label></td>
  				<td width="15"><label>Brust:</td><td width="15">
  					<select name="brust">
  				
  			    <?php echo "<option selected value='$arrModels[brast]'>$arrModels[brast]</option>";?>		
  			    ...
  			    <td width="15"><label>Haare:</td><td width="15"><input type="haare" name="haare"  value="<?php echo $arrModels['hare'] ?>" /></label></td>
  			    <td width="15"><label>Sedcard:</td><td width="15"><input type="sedcard" name="sedcard" value="<?php echo $arrModels['sedcard'] ?>"  /></label></td>
  			
  			</tr>
  			<tr>
  				
  			    <td width="15"><label>Augen:</td><td width="15"><input type="augen" name="augen"  value="<?php echo $arrModels['eye_color'] ?>" /></label></td>
  			    <td width="15"><label>Taille:</td><td width="15">
  			    		<select name="taille">
  			    <?php echo "<option selected value='$arrModels[taille]'>$arrModels[taille]</option>";?>				
  				...
  				<td width="15"><label>Hufte:</td>
  					<td width="15">
  				  <select name="hufte">
  				  	<?php echo "<option selected value='$arrModels[hufte]'>$arrModels[hufte]</option>";?>	
  			    ...
  			    <?php echo "<option selected value='$arrModels[bewertung]'>$arrModels[bewertung]</option>";?>		
  		...
  		<table>
  			...
  			<tr>
  			    ...
  			    <td ><textarea type="notizien" name="notizien" value="" placeholder="Notizien..." rows="8" cols="120">
  			    	<?php echo $arrModels['notice'] ?>
  			    	
</textarea></td>


<td></br>
	<input type="hidden" name="fotox" value="<?php echo $arrModels[foto1]  ?>">

	<img src="<?php echo $GLOBALS['IMG'].$arrModels[foto1]?>"  width="100" height="120" alt="Bild" />
	<input type="file" name="fileToUpload" id="fileToUpload">
</td>
  			  
  			</tr>
  			<tr><td align="center"><input type="submit" name="signin" value="Bearbeiten" /></td></tr>
  	    </table>
...
<script type="text/javascript" src="<?php echo $GLOBALS['JS']; ?>kundendetails.js"></script>
